...
Measured basis: scripts/clean/results/steiner_tokens_by_cell.csv, summarised by
...
def table(d):
    ...
    tex = f"""% Generated by scripts/clean/make_figures_placement.py -- do not edit by hand.
\\begin{{table*}}[t]
\\ROOF{{}}
