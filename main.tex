...
\begin{figure}[t]
  \centering
  \includegraphics[width=\columnwidth]{figures/fig_components.pdf}
    \caption{Energy breakdown of a four-agent RAG workflow on Llama-3 8B. LLM generation dominates
  ($\sim\!90\%$), followed by orchestration; retrieval, tools, and inter-agent transmission are minor.}
